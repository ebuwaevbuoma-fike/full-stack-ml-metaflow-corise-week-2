...
#create a labeling fuction, ratings >=4 are positive
...
class BaselineChallenge(FlowSpec):
    ...
    def baseline(self):
        ...
        maj_clf.fit(self.traindf["review"], self.traindf["label"])
    
        predictions = maj_clf.predict(self.valdf["review"]) # TODO: predict the majority class
